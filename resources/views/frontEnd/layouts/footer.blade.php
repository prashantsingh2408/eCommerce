<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2020 Webinux Inc. All rights reserved.</p>
                <p class="pull-right"> By <span><a target="_blank" href="http://prashantsingh2408@gmail.com">Webinux tranee Prashant</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->