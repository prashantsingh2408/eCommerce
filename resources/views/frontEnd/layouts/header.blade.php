                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 8417891491</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> prashantsingh@gmial.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{url('/')}}"><img style="width:100px; height:100px" src="{{asset('frontEnd/images/home/logo.png')}}" alt="" /></a>
                    </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a target="_blank" href="http://prashantsingh2408@gmail.com">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
